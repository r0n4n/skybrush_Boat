...
// Provide Rover-specific implementation of the drone show mode. While most of
// the logic for performing a show is present in AC_DroneShowManager, this class
// allows Rover to override base functionality - for example, to switch flight
